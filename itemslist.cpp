...
void ItemsList::setItemsList(const QString &buttonName)
{
    if(buttonName == "T2")
    {
        ...
        itemsList.append(new MedicalTable("/images/images/plug.png", "UNCHECKED", false,"transparent"));
...
//        itemsList.append(new MedicalTable("", "CHECKED", true,"#00CED1"));
//        itemsList.append(new MedicalTable("", "CHECKED", true,"white"));
        itemsList.append(new MedicalTable("/images/images/test.png", "CHECKED", false,"transparent")); // CHECKED
        itemsList.append(new MedicalTable("/images/images/test.png", "UNCHECKED", true,"transparent"));
        itemsList.append(new MedicalTable("/images/images/test.png", "CHECKED", false,"transparent")); // CHECKED
        itemsList.append(new MedicalTable("/images/images/test.png", "CHECKED", false,"transparent")); // CHECKED
        itemsList.append(new MedicalTable("/images/images/test.png", "CHECKED", false,"transparent")); // CHECKED
        itemsList.append(new MedicalTable("/images/images/test.png", "CHECKED", false,"transparent")); // CHECKED
        ...
        itemsList.append(new MedicalTable("/images/images/test.png", "UNCHECKED", true,"transparent"));
        itemsList.append(new MedicalTable("/images/images/test.png", "UNCHECKED", true,"transparent"));
        itemsList.append(new MedicalTable("/images/images/test.png", "UNCHECKED", true,"transparent")); // OK
        itemsList.append(new MedicalTable("/images/images/test.png", "UNCHECKED", true,"transparent"));
        itemsList.append(new MedicalTable("/images/images/test.png", "CHECKED", true,"transparent"));
        itemsList.append(new MedicalTable("", "CHECKED", true,"#00CED1"));
        itemsList.append(new MedicalTable("", "CHECKED", true,"white"));
        emit itemsListChanged(getItemsList());
    }
